...
namespace NamelessOld.Libraries.DB.Tessa
{
    ...
    public class VoidAccess_Transaction<Input>
    {
        #region Variables
        /// <summary>
        ...
        public delegate void ActionTransaction(Access_Connector conn, params Input[] trParameters);
        /// <summary>
        ...
        /// <param name="trParameters">Transaction parameters</param>
        public delegate void ActionBgTransaction(Access_Connector conn, ref BackgroundWorker bgWorker, Input trParameters);
        /// <summary>
        ...
        public VoidAccess_Transaction(ConnectionData connData, ActionTransaction action)
        {
            this.Data = connData;
        ...
        public VoidAccess_Transaction(ConnectionData connData, ActionBgTransaction action)
        {
            this.Data = connData;
        ...
        /// <param name="action">Microsoft Access transaction action</param>
        public VoidAccess_Transaction(String connString, ActionTransaction action)
        {
        ...
        /// <param name="connString">Microsoft Access connection string</param>
        /// <param name="action">Microsoft Access background transaction action</param>
        public VoidAccess_Transaction(String connString, ActionBgTransaction action)
        {
            this.ConnectionString = connString;
            this.trBgAction = action;
        }
