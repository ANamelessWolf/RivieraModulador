...
namespace NamelessOld.Libraries.DB.Misa
{
    ...
    public class Oracle_Transaction<Input, Output>
    {
        #region Variables
        /// <summary>
        ...
        public delegate Output ActionTransaction(Oracle_Connector conn, params Input[] trParameters);
        /// <summary>
        ...
        /// <param name="trParameters">Transaction parameters</param>
        /// <returns>Transaction result</returns>
        public delegate Output ActionBgTransaction(Oracle_Connector conn, ref BackgroundWorker bgWorker, Input trParameters);
        /// <summary>
        ...
        public Oracle_Transaction(ConnectionData connData, ActionTransaction action)
        {
            this.Data = connData;
        ...
        public Oracle_Transaction(ConnectionData connData, ActionBgTransaction action)
        {
            this.Data = connData;
        ...
        /// <param name="action">Oracle transaction action</param>
        public Oracle_Transaction(String connString, ActionTransaction action)
        {
        ...
        /// <param name="connString">Oracle connection string</param>
        /// <param name="action">Oracle background transaction action</param>
        public Oracle_Transaction(String connString, ActionBgTransaction action)
        {
            this.ConnectionString = connString;
            this.trBgAction = action;
        }
